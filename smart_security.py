...
while True:
	...
	thresh = cv2.dilate(thresh, None, iterations=1)  # dilation fills in neighbouring pixels as 1 (for binary) to add pixels to the outer border (dilating pixels in the threshold array)
